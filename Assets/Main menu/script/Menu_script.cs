...
public class Menu_script : MonoBehaviour
{
    ...
    void Start()
    {
            ...
            AppendRowSpell("Воздушная аура","Позволяет сделать персонажу быстрый рывок, который будет поддерживаться ветром. Ветер настолько силён, что персонаж даже не упадёт не будь под ним опоры.",0,"WD");
